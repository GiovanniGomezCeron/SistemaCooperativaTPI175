					...
					<div class="col-8">
						...
						<form action="" method="post">
							...
							<div class="row col-12">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<select name="plazocuota" id="plazocuota" class="form-control">
											<option value="1">Edgar Giovanni Gómez</option>
											<option value="2">René Eduardo Hernández</option>
											<option value="3">Alicia Mónica Flores</option>
										</select>
									</div>
								</div>
							...
							<div class="row col-12">
								...
								<div class="row col-12">
									<input type="submit" value="Registrar Préstamos" class="btn btn-success active ml-3" id="btnRegistrarSocio">				
								</div>
